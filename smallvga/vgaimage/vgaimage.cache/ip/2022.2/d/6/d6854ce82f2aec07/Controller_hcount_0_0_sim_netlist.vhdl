...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_hcount is
  ...
  attribute SOFT_HLUTNM of \countshared[2]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \countshared[3]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \countshared[4]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \countshared[6]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \countshared[7]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \countshared[8]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \countshared[9]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \data[7]_INST_0\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \data[8]_INST_0\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \data[8]_INST_0_i_2\ : label is "soft_lutpair3";
begin
...
\countshared[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFF8000"
    )
        port map (
...
\countshared[6]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\countshared[7]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"78788878"
    )
        port map (
      I0 => \^q\(5),
      I1 => \countshared[9]_i_2_n_0\,
      I2 => countshared_reg(7),
      I3 => countshared_reg(8),
      I4 => \data[8]_INST_0_i_1_n_0\,
      O => plusOp(7)
    );
\countshared[8]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7888F0F0"
    )
        port map (
...
\countshared[9]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFF8000"
    )
        port map (
...
\countshared[9]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\data[8]_INST_0_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFB"
    )
        port map (
