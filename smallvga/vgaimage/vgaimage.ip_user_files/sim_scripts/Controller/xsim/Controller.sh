...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L xil_defaultlib -L secureip -L xpm --snapshot Controller xil_defaultlib.Controller -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim  Controller -key {Behavioral:sim_1:Functional:Controller} -tclbatch cmd.tcl -protoinst "protoinst_files/Controller.protoinst" -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="F:/xilinx/Vivado/2022.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Controller.wdb xsim.dir)
